...
from utils import ROOT, generate_question_table, generate_user_table, bar_images, generate_table
from html_generation import header, JQUERY_LINKS
...
def generate_topic_page(db, topic, questions):
    ...
    s2 = generate_user_table(users, db, prefix='../',
                             keys=['Asked', 'Answered', 'Accepted'], params={"order": [(3, "desc")]})
